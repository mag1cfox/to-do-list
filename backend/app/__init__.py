...
def create_app(config_class=None):
    ...
    # 注册蓝图
    from routes import auth_routes, user_routes, task_routes, task_category_routes, project_routes
    ...
    app.register_blueprint(task_category_routes.bp, url_prefix='/api/task-categories')
